        ...
        <div class="container">
            <div class="row">
                <div class="slider-content">
                    <div class="row">
                        <div class="col-lg-12">
                            <h2 style="color: black;">{{ $countryName }}’s <em>Cities &amp; Towns</em></h2>
                        </div>
                        <div class="col-lg-12">
                        ...
                        @foreach ($cities as $city)
                            <div class="item">
                                <div class="thumb">
                                    <img src="{{ asset('assets/images/' . $city->image) }}" alt="">
                                    <div class="text">
                                        <h4 style="color: black;">{{ $city->name }}<br><span><i class="fa fa-users"></i>
                                                234 Check Ins</span>
                                        </h4>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            <div class="info-item">
                                <div class="row">
                                    <div class="col-lg-6">
                                        <h4 style="color: black;">{{ $citiesCount }}+</h4>
